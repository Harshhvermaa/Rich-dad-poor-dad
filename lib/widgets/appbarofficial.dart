...
class appbarOfficial extends StatelessWidget {
  // String? username;
  appbarOfficial({super.key ,});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Container(
            margin: EdgeInsets.only(top:  screenHeight * 0.05,left: 12,right: 10),
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Image(image: AssetImage("assets/Vector.png"),color: Color.fromARGB(255, 192, 192, 192).withOpacity(0.8),),
                  ),
                ),
          ...
          SizedBox(height: 5,),
          Divider(color: Color(0xFF202022),),
        ],
      ),
    );
  }
